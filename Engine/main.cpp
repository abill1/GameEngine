...
inline ID3D11Buffer* CreateConstantBuffer(ID3D11Device* pDevice, unsigned int _byteWidth, void* _pResource);
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR pCmdLine, int nCmdShow)
{
	...
	// // TODO: Investigate this code more to leverage it
 	...
 	// pDXGIFactory1->MakeWindowAssociation(window.GetHwnd(), DXGI_MWA_NO_ALT_ENTER);
	...
	// fVect clearColor = { 0.2f, 0.2f, 0.2f, 1.0f };
 	...
 	while (window.IsOpen())
 	{
 		...
 		// ------ Clear Screen
 		// pDeviceContext->ClearRenderTargetView(pRenderTargetView, &clearColor.x);
...
// 	case WM_LBUTTONDOWN:
// 	{
// 		inputDevice.ExecuteMouse(Engine::MOUSE_INPUTS::LEFT_DOWN, hwnd, wParam, lParam);
// 		break;
// 	}
// 	case WM_LBUTTONUP:
// 	{
// 		inputDevice.ExecuteMouse(Engine::MOUSE_INPUTS::LEFT_UP, hwnd, wParam, lParam);
// 		break;
// 	}
// 	case WM_MOUSEMOVE:
// 	{
// 		inputDevice.ExecuteMouse(Engine::MOUSE_INPUTS::MOVE, hwnd, wParam, lParam);
// 		break;
// 	}
// 	case WM_PAINT:
// 	{
